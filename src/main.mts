...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "1": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/C2zniPn45RnLDGzVeGZCx2Sw3GXrbc9gL4ZfL8B8Em2j",
  },
  // Polygon subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "137": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/GrZQJ7sWdTqiNUD8Vh2THaeBM4wGwiF8mFv9FBfyzwxm",
  },
  // Avalanche subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "43114": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/9nh6Ums63wFcoZpmegyPcAFtY3CAzQc3S6cuERALYMqa",
  },
};
...
function transformMarketsToTags(chainId: string, markets: Market[]): ContractTag[] {
  ...
  return validTokens.map((token) => {
    ...
    return {
      ...
      "Project Name": "Aave V2",
      "UI/Website Link": "https://aave.com",
      "Public Note": `Aave V2's official ${token.name} token contract.`,
    };
  });
}
